...
FROM (SELECT * FROM
				...
				BULK 'https://YourStorageAccount.blob.core.windows.net/YourContainer/YourFolder/Delta/Factinternetsales/',
   				FORMAT = 'Delta'
			) AS FactInternetSales )AS FIS 
INNER JOIN 
	     (SELECT *FROM
					OPENROWSET(-----------Replace the storage path \container
					BULK 'https://YourStorageAccount.blob.core.windows.net/YourContainer/YourFolder/Delta/Factinternetsalesreasons',
   					FORMAT = 'Delta'
...
INNER JOIN
   (SELECT * FROM
				OPENROWSET(-----------Replace the storage path \container
					BULK 'https://YourStorageAccount.blob.core.windows.net/YourContainer/YourFolder/Delta/Dimsalesreasons',
   					FORMAT = 'Delta'
