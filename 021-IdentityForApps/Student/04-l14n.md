...
**NOTE:** This web application is located in the **HarnessApp** folder under the [student resources](Resources/HarnessApp) or in your Teams channel Files tab.
...
**NOTE:** These files are located in the **PageTemplates** folder under the [student resources](Resources/PageTemplates) or in your Teams channel Files tab.
