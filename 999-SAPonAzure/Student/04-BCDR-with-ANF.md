# Challenge 4: Backup and Disaster Recovery with Azure NetApp Files
...
```**_-Please note that this OpenHack environment is a scaled down version of the above production-like scenario. Also, we will not protect Shared binaries for this challenge_-**```
