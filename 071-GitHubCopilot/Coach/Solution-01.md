...
- Ways to interact with GitHub Copilot:
  - **Inline Completions** - Ghost text as you type, `Ctrl/Cmd + Enter` for up to 10 suggestions
  - **Copilot Chat Panel** - Dedicated chat sidebar for conversational assistance
  - **Inline Chat** - `Ctrl/Cmd + I` to edit code in-place
  - **Quick Chat** - `Ctrl/Cmd + Shift + I` for quick questions
  - **Context Menu** - Right-click → Copilot for Fix, Explain, Generate Docs, Generate Tests
  - **Sparkle Icon (✨)** - Context-aware AI assistance throughout VS Code UI
