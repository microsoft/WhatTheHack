...
As Dapr can run on a variety of hosts, you'll start by running Dapr in self-hosted mode onasdfasdf your computer. Then, you'll deploy the Dapr application to run in Azure Kubernetes Service.
