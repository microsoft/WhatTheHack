...
service_bus_controller_orange = func.Blueprint()


@service_bus_controller_orange.function_name("service_bus_controller_orange")
@service_bus_controller_orange.service_bus_queue_trigger(arg_name='record', connection="SERVICE_BUS_CONNECTION_STRING",
                                                         queue_name='orange')
def service_bus_handler_orange(record: func.ServiceBusMessage):
    logging.info('service_bus_controller_orange function processed a request.')
