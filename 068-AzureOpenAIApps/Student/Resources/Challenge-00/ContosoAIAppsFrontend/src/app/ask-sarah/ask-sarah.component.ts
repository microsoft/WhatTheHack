...
@Component({
  selector: 'app-ask-sarah',
  templateUrl: './ask-sarah.component.html',
  styleUrls: ['./ask-sarah.component.css']
})
export class AskSarahComponent {
  ...
  public sendMessage() {
    ...
    this.openAiApiService.askSarah<SimpleChatResponse>(this.userMessage)
        .subscribe(response => {
