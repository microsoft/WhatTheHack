...
service_bus_controller_tangerine = func.Blueprint()


@service_bus_controller_tangerine.function_name("service_bus_controller_tangerine")
@service_bus_controller_tangerine.service_bus_queue_trigger(arg_name='record', connection="SERVICE_BUS_CONNECTION_STRING",
                                                            queue_name='tangerine')
def service_bus_handler_orange(record: func.ServiceBusMessage):
    logging.info('service_bus_controller_tangerine function processed a request.')
    ...
    service_bus_queue_name = "tangerine"
