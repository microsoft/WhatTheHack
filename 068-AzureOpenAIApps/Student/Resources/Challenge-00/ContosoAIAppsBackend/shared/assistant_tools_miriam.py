...
def v_yacht_travel_party_size_within_capacity(yacht_id: str, travel_party_size: int) -> str:
    result = yacht_travel_party_size_within_capacity(yacht_id, travel_party_size)
    return serialize_assistant_response(result)
...
def v_yacht_is_available_for_date(yacht_id: str, date: str) -> str:
    response = yacht_is_available_for_date(yacht_id, date)
    return serialize_assistant_response(response)
