...
# Coach's Guides
## Challenge 0: **[Pre-requisite - Ready, Set, GO!](./Solution/Challege00.md)**
- Install VS Code
...
## Challenge 1: **[Extract, transform and load patient data](./Solution/Challenge01.md)**
...
- Ingest test FHIR patient data into FHIR Server
 ...
 ## Challenge 2: **[Stream FHIR patient data and unit testing](./Solution/Challenge02.md)**
...
## Challenge 3: **[Stream patient data with event-driven architecture](./Solution/Challenge03.md)**
...
## Challenge 4: **[Index patient data for patient lookup](./Solution/Challenge04.md)**
...
## Challenge 5: **[Display patient search results](./Solution/Challenge05.md)**
