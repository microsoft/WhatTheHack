...
| --- | --- |
| `computerVisionApiUrl` | Computer Vision API endpoint you copied earlier. Append **vision/v3.2/ocr** to the end. Example: [https://westus.api.cognitive.microsoft.com/vision/v3.2/ocr](https://westus.api.cognitive.microsoft.com/vision/v3.2/ocr) |
