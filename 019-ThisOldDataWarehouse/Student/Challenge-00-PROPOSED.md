...
You will find the provided `hacksetup.sh` script and its associated ARM Template in the `/Challenge0/` folder of the `Resources.zip` file provided to your by your coach.
