...
resource imageTemplateName_resource 'Microsoft.VirtualMachineImages/imageTemplates@2020-02-14' = {
  ...
  properties: {
    ...
    customize: [
      ...
      {
        type: 'WindowsRestart'
        restartCheckCommand: 'write-host \'Reboot VM\''
        restartTimeout: '15m'
      }
      {
        type: 'WindowsUpdate'
      ...
      {
        type: 'PowerShell'
        name: 'Install Spanish and Japanese Language Packs'
        runElevated: true
        runAsSystem: true
        scriptUri: 'https://raw.githubusercontent.com/JasonBeck2/SampleCode/master/image-builder/04-installLanguagePacks.ps1'
      }
    ]
    distribute: [
      {
        type: 'SharedImage'
        galleryImageId: sigImageId
        runOutputName: 'aiboutput'
        artifactTags: {
          source: 'WVD-FastHack'
        }
        replicationRegions: [
