...
- Rate Limits \
  **Solution:** Have students go into their model deployments in the Microsoft Foundryand adjust the TPM allocation for that model to a higher value using the toggle.
