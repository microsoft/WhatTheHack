...
Invoke-WebRequest -Uri "https://github.com/jrzyshr/AzureMonitoringRefresh/blob/main/xxx-AzureMonitoring/Student/Resources/sources/masterWTH.zip?raw=true" -OutFile $zipFileeShop
