...
- Override template parameters, student should have this solution:
  ...
  - check the YAML in the solutions **(./solutions/armtemplatedeployment.yaml)** for the prefix part
- Check the **(./solutions/solution-04.json)** for entire possible solution for this challenge. 
