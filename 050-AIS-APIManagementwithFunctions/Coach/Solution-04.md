...
- Click Get New Access Token which will pop-up another browser window prompting you to log-in.  Once successful, you will redirected back with the generated access token.  Click Use Token to add that to the request header.
...
[Back to Top](#solution-04---securing-backends-apis)
